...
import FilterPrinterCCTVs from "../Components/ProductsUse/FilterPrinterCCTVs";
...
const ProductsPrintersAndCCTV = () => {
  ...
  const handleFilteredObject = (filteredObject) => {
    let filteredProducts = [...PrintersAndCCTVs];
  ...
  useEffect(() => {
    let sortedProducts = [...PrintersAndCCTVs];
  ...
  return (
    <div>
      <div className="mt-4 flex flex-col md:flex-row my-8">
        {/* Filters Section */}
        <FilterPrinterCCTVs sendFilteredObject={handleFilteredObject} />
...
export default ProductsPrintersAndCCTV;
