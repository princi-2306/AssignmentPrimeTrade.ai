...
import FilterDevices from "../Components/ProductsUse/FilterDevices";
...
const ProductsDevices = () => {
  ...
  const handleFilteredObject = (filteredObject) => {
    let filteredProducts = [...ComputerAccessories];
  ...
  useEffect(() => {
    let sortedProducts = [...ComputerAccessories];
  ...
  }, [ComputerAccessories, sortOption]);
  ...
  return (
    <div>
      <div className="mt-4 flex flex-col md:flex-row my-8">
        {/* Filters Section */}
        <FilterDevices sendFilteredObject={handleFilteredObject} />
...
export default ProductsDevices;
