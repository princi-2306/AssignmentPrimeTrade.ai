...
const FilterParts = ({sendFilteredObject}) => {
  ...
  const handlePartsConditionChange = (condition) => {
    setCondition((prev) => ({
      ...prev,
  ...
  const applyFilters = () => {
    ...
    const filteredObject = {
      ...
      priceRange,
      isAvailable,
      condition: adjustedPartsCondition, // Adjusted laptop condition
        ...
        >
          ...
          <div className="my-4 mx-2 border px-4 py-3 shadow-md bg-slate-50 rounded-md">
            ...
            >
              ...
              <option value="overclocking">Overclocking</option>
          ...
          <div className="my-4 mx-2 border px-4 py-3 shadow-md bg-slate-50 rounded-md">
            ...
            <select
              ...
              className="w-full border-gray-300 rounded shadow-sm focus:ring-blue-500 focus:border-blue-500 px-2 py-1"
            >
              <option value="">All Parts Brands</option>
            ...
            <div className="space-y-2 flex-col flex gap-y-1">
              <div className="inline-flex items-center pt-2">
                <input
                  ...
                  onChange={() => handlePartsConditionChange('firstHand')}
              ...
              <div className="inline-flex items-center">
                <input
                  ...
                  onChange={() => handlePartsConditionChange('secondHand')}
                  className="form-checkbox h-5 w-5 text-blue-600"
                />
