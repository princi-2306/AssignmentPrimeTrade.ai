...
const ProductItemDevices = (props) => {
  
    const {currency} = useContext(ShopContext);

  return (
    <Link target='_blank' to={`/store/productsDevices/${props.id}`} className='text-gray-700 cursor-pointer'>
...
export default ProductItemDevices