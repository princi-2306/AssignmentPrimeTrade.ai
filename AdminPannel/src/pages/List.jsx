...
const ITEM_TYPES = ['Laptop', 'Device', 'Parts', 'PrinterCCTV'];

const ENDPOINTS = {
  Laptop: 'productLaptops/listProductLaptop',
  Parts: 'productPart/listProductPart',
  Device: 'productDevice/listProductDevice',
  PrinterCCTV: 'productPrinterCCTV/listProductPrinterCCTV'
};
const REMOVE_ENDPOINTS = {
  Laptop: 'productLaptops/removeProductLaptop',
  Parts: 'productPart/removeProductPart',
  Device: 'productDevice/removeProductDevice',
  PrinterCCTV: 'productPrinterCCTV/removeProductPrinterCCTV'
};
...
const List = ({ token }) => {
  ...
  const removeProducts = async (_id) => {
    ...
    try {
      ...
      if (response.data.success) {
        await fetchList();
        toast.success(`${itemType} product removed successfully`);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-8">
          ...
          <div className="text-center space-y-4">
            <Title title1="LIST PRODUCT" title2="ITEMS" />
      ...
      <RemoveConfirmModal 
        ...
        onConfirm={() => removeProducts(selectedProduct?._id)}
